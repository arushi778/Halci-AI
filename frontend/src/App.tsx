          ...
          {view === 'output' && (
            ...
            >
              <div className="text-center space-y-2">
                ...
                <p className="text-zinc-400">Paste the response generated by your LLM for a sentence-level audit.</p>
              </div>
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    className="w-full h-64 bg-zinc-900 border border-zinc-800 rounded-xl p-4 text-sm focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all resize-none placeholder:text-zinc-600"
                  />
                </div>
